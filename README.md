...
| **[agent-skills/autoace](./agent-skills/autoace/)** | Agent Skill **`autoace`**：`npx -y skills add kuaiyou-app/kuaiyou-open-source --skill autoace -g -y`（整包 `SKILL.md` + `reference.md` + `craft.md`）。 |
